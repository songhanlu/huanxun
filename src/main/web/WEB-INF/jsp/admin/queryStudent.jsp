    ...
    <script type="text/javascript">
        $(function () {
            $("#studentDataGrid").datagrid({
                url:'${pageContext.request.contextPath}/student/queryStudentByNameAndAgencyAndAge.do',
                method:'GET',
                pagination:true,
                rownumbers:true,
                striped:true,
...
<body>
<div>
    <form id="queryStudentForm" action="${pageContext.request.contextPath}/student/toQueryStudentByNameAndAgencyAndAge.do" method="get">
        ...
        <input type="submit"id="queryEmployeeButton" class="easyui-linkbutton" iconCls="icon-search" > 查询</input>
    </form>
</div>
