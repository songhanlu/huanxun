...
public interface StudentCourseService {
    //查询所有学生购买的课程（多条件）
    PageInfo<StudentCourse> findAllStudentCourse_liyujia(Integer pageNum, Integer pageSize, StudentCourse studentCourse);

    //根据stuCourseID查询学生课程
    StudentCourse findStudentCourseByID_liyujia(Integer id);
